...
<div id="page-body" role="main">
    ...
    <ul>
        ...
        <li><g:link controller="placesImport" action="occurrencesplaces"><g:message code="admin.import.occurrencesplaces.label"/></g:link> <g:message code="admin.import.occurrencesplaces.lead"/></li>
        <li><g:link controller="placesImport" action="speciescountsplaces"><g:message code="admin.import.speciescountsplaces.label"/></g:link> <g:message code="admin.import.speciescountsplaces.lead"/></li>
        <br>
